...
function init() {
    ...
    new Body(physics, { type: "static", friction:0, x: cpw*48 , y: cph*10, height: cph * 2 , width: cpw * 16 });
    new Body(physics, { type: "static", friction:0, x: cpw*48 , y: cph*90, height: cph * 2 , width: cpw * 20 });
    new Body(physics, { type: "static", friction:0, x: cpw*18 , y: cph*24, height: cph * 2 , width: cpw * 28 });
    new Body(physics, { type: "static", friction:0, x: cpw*86 , y: cph*30, height: cph * 2 , width: cpw * 28 });
    new Body(physics, { type: "static", friction:0, x: cpw*50 , y: cph*38, height: cph * 2 , width: cpw * 36 });
    new Body(physics, { type: "static", friction:0, x: cpw*18 , y: cph*48, height: cph * 2 , width: cpw * 36 });
    new Body(physics, { type: "static", friction:0, x: cpw*60 , y: cph*58, height: cph * 2 , width: cpw * 80 });
    new Body(physics, { type: "static", friction:0, x: cpw*12 , y: cph*84, height: cph * 2 , width: cpw * 24 });

    new Body(physics, { type: "static", friction:0, x: cpw*16 , y:cph*84, height: cph*2 , width:    Math.sqrt(Math.pow(cpw*32,2)+Math.pow(cph*20,2)), angle: -45*degToRad});
    new Body(physics, { type: "static", friction:0, x: cpw*96 , y:cph*84, height: cph*2 , width: Math.sqrt(Math.pow(cpw*32,2)+Math.pow(cph*20,2)), angle: 45*degToRad});
	 
    //new Body(physics, { x: 5, y: 8, width: 50 / s, height: 60 / s, name:"spahe1", density:3, friction:0 });		// Box van 40 x 40 pixels
	ball = new Body(physics, {color:"blue", x: 260/s, y: 450/s, shape: "circle", radius: 5 / s, name:"balloon" });	// Cirkel van 2.5 * 20 = 50 pixels radius
    ...
    level3song = new Media("/android_asset/www/Level3.mp3");
